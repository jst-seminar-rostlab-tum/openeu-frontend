...
export function EventListDialog({date, events, MAX_VISIBLE_EVENTS=3, children}: EventListDialogProps) {
                ...
                <DialogHeader>
                    <DialogTitle>
                        <div className="flex items-center gap-2">
                            <EventBullet color={cellEvents[0]?.color as TMeetingColor} className="" />
                    ...
                    {cellEvents.map((event) => (
                        <div
                            ...
                            className={cn(
                                ...
                                {
                                    [dayCellVariants({ color: event.color as TMeetingColor })]:true
                                }
                            )}
                        >
                            ...
                            <div className="flex-1">
                                ...
                                <p>
                                    {format(event.meeting_start_datetime, 'EE dd MMMM')}
                                </p>
                            </div>
                        </div>
                    ))}
