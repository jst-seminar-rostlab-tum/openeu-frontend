...
export function getEventsCount(events: MeetingData[], date: Date, view: TCalendarView): number {
    ...
    return events.filter((event) => compareFn(parseISO(event.meeting_start_datetime), date)).length;
}
...
export function calculateMonthEventPositions(
    ...
    const sortedEvents = [
        ...multiDayEvents.sort((a, b) => {
            ...
            return bDuration - aDuration || parseISO(a.meeting_end_datetime).getTime() - parseISO(b.meeting_start_datetime).getTime();
        }),
